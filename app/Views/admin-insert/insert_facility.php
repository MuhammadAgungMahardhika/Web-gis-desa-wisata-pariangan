...
<section class="section">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item "><a href="<?= base_url('manage_facility') ?>">List facility</a></li>
            <li class="breadcrumb-item active" aria-current="page">Insert facility</li>

        </ol>
    </nav>
    <form class="form form-vertical" action="<?= base_url('manage_facility/save_insert'); ?>" method="post">
        <div class="row">
            <!-- Object Detail Information -->
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?= base_url('manage_facility'); ?>" role="button" class="btn btn-primary justify-item-center" title="List facility"><i class="fa fa-arrow-left"></i></a>

...
<section class="section">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item active" aria-current="page">Insert homestay</li>

        </ol>
    </nav>
    <form class="form form-vertical" action="<?= base_url('manage_homestay/save_insert'); ?>" method="post">
        <div class="row">
            <!-- Object Detail Information -->
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?= base_url('manage_homestay'); ?>" role="button" class="btn btn-primary justify-item-center" title="List homestay"><i class="fa fa-arrow-left"></i></a>
                        <h4 class="card-title text-center">Insert homestay</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="form-body">

...
<section class="section">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item active" aria-current="page">Insert culinary place</li>

        </ol>
    </nav>
    <form class="form form-vertical" action="<?= base_url('manage_culinary_place/save_insert'); ?>" method="post">
        <div class="row">

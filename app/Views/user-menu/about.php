                ...
                <div class="card-body">
                    ...
                    <div class="row" style="min-height: 100vh;">
                        <div class="col-xl-8 col-lg-8">
                            <p class="text-left">Tourism name : <?= $parianganData->name; ?></p>
                            <p class="text-left">Tourism type : <?= $parianganData->type_of_tourism; ?></p>
                            <p class="text-left">Tourism adress : <?= $parianganData->address; ?></p>
                            <p class="text-justify">Description : <br><?= $parianganData->description; ?> </p>

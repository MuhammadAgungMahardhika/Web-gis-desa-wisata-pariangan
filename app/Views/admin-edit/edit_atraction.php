...
<section class="section">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item "><a href="<?= base_url('manage_atraction') ?>">List atraction</a></li>
            <li class="breadcrumb-item "><a href="<?= base_url('manage_atraction/detail/' . $objectData->id); ?>">Detail atraction</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit atraction</li>
        </ol>
    </nav>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-body">
                                        ...
                                        <select class=" form-select" id="category" name="category">
                                            ...
                                            <?php foreach ($categoryData as $category) : ?>
                                                <?php if ($objectData->category) : ?>
                                                    <?php if ($objectData->category_atraction_id == $category->id) : ?>
                                                        <option value="<?= $objectData->category_atraction_id; ?>" selected><?= esc($objectData->category); ?></option>
                                                    <?php else : ?>
                                ...
                                <div class="form-group">
                                    <label for="status" class="col col-form-label">Employe</label>
                                    <div class="col">

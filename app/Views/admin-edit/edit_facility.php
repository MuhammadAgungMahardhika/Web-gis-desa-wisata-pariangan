...
<section class="section">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item "><a href="<?= base_url('manage_facility/detail/' . $objectData->id); ?>">Detail facility</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit facility</li>
        </ol>
    </nav>
    <form class="form form-vertical" action="<?= base_url('manage_facility/save_update/' . $objectData->id); ?>" method="post">
        <div class="row">

...
<section class="section">
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ">
            ...
            <li class="breadcrumb-item "><a href="<?= base_url('manage_souvenir_place/detail/' . $objectData->id); ?>">Detail souvenir place</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit souvenir place</li>
        </ol>
    </nav>
    <form class="form form-vertical" action="<?= base_url('manage_souvenir_place/save_update/' . $objectData->id); ?>" method="post">
        <div class="row">
            <!-- Object Detail Information -->
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?= base_url('manage_souvenir_place/detail/' . $objectData->id); ?>" role="button" class="btn btn-primary justify-item-center" title="back to detail souvenir place"><i class="fa fa-arrow-left"></i></a>
                        <h4 class="card-title text-center">Edit Souvenir Place</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="form-body">
